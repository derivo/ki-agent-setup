...
Stand 2026-07-25: **E1–E12 sind gesättigt** — der erste Opus-5-Sweep lieferte
12/12 (Protokoll unten), davor zwei Voll-Sweeps 10/10 auf Opus 4.8. Das ganze Set
ist damit **Regressions-Set**: es belegt, dass nichts kaputtgegangen ist, und kann
nicht mehr belegen, dass eine neue Regel etwas verbessert. **E11** war von Beginn an
Drift-Wächter; **E12** ebenfalls (A/B am 2026-07-23 auf Opus 4.8: **kein
Discriminator** — beide Seiten verwarfen Weiß-auf-Gelb und prüften Kontrast von
selbst).

Der Modellwechsel auf Opus 5 hat den Drift-Wächter-Status **nicht** entschärft: dass
das Set grün bleibt, heißt nur, dass die Regeln nicht *widersprochen* werden. Ob sie
noch tragen, sagt weiter nur ein A/B. Wer eine neue Regel rechtfertigen will, braucht
eine Aufgabe, die ohne sie fällt — und die entsteht aus einem realen Fehlschlag, nicht
aus Vollständigkeitsdrang.
