...
| [`/hx:audit`](audit.md) | `$hx-audit` | Drift-Audit über den **Bestand**: Architektur- und Design-System-Verstöße belegt melden, ohne Auto-Fix | GUARDRAILS A + G, ADR_TEMPLATE, Stack-Adapter |
